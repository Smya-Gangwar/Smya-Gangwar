...
#define wifi_ssid "Ravi188"
#define wifi_password "115204416"
...
void setup() {
  ...
  client.setServer(mqtt_server, 1883);    // Configure MQTT connexion where 1883 is port
  client.setCallback(callback);           // to specify handling function that is executed when a MQTT message is received.   
  dht.begin();
}
